...
float cloud(vec2 p, float speed, float animSpeed, float innerAnimSpeed, float detail) {
...
half4 main(float2 coord) {
  ...
  alpha += cloud(p * 3.0 * tiling, baseSpeed * 0.3 + 0.25, 0.2, 0.1, 0.5) * 0.8;
  if(density > 1) {
    alpha += cloud(p * 5.0 * tiling, baseSpeed * 0.3 + 0.25, 0.4, 0.1, 0.8) * 0.5;
  }
  if(density > 2) {
    alpha += cloud(p * 2.0 * tiling, baseSpeed * 0.3 + 0.25, 0.1, 0.1, 0.3) * 0.5;
  }
  if(density > 3) {
